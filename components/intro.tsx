...
function Intro() {
  ...
  const { setActiveSection, seTimeOfLastClick } = useActiveSectionContext();
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm MadhuSudan.</span> I'm a{" "}
        <span className="font-bold">Front-end developer</span> with . I enjoy
      ...
      >
        ...
        <a
          href="https://drive.google.com/file/d/1VScYxLCDenTYX9gmgaF9GB7yKM60RyZw/view?usp=sharing"
          download
